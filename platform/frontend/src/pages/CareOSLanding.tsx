...
import {
  ArrowRight, ArrowUpRight, Cloud, Cpu, Eye, Heart, Lock, User,
} from 'lucide-react'
import { api } from '../api'
    ...
    <header className="sticky top-0 z-50 bg-[#111] border-b border-white/10">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 sm:px-10 py-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link to="/login/clinician" className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-[13px] font-semibold text-white bg-white/10 border border-white/20 hover:bg-white/20 transition">
